        ...
        body: BlocConsumer<DeforMonitorBloc, DeforMonitorState>(
          listener: (context, deforMonitorState) async {
            if (deforMonitorState is Defor12MonitorStateInit) {
              ...
              warning = false;
              running = false;
            } else if (deforMonitorState is Defor12MonitorStateLoadingRequest) {
              loadingDialog.show();
              ...
              data1 = deforMonitorState.deforMonitorData.forceCylinderSp12
                  .toString();
              data3 = deforMonitorState.deforMonitorData.noPressSp12.toString();
              data2 =
                  deforMonitorState.deforMonitorData.timeHoldSp12.toString();
              data4 = deforMonitorState.deforMonitorData.noPressPv1.toString();
              data5 = deforMonitorState.deforMonitorData.noPressPv2.toString();
              data21 = deforMonitorState.deforMonitorData.forceCylinderSp3
                  .toString();
              data22 =
                  deforMonitorState.deforMonitorData.timeHoldSp3.toString();
              data23 = deforMonitorState.deforMonitorData.noPressSp3.toString();
              data24 = deforMonitorState.deforMonitorData.noPressPv3.toString();
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: new BoxDecoration(
                                    color:
                                        warning ? Colors.green : Colors.black26,
                                    shape: BoxShape.circle,
                                  ),
                                ),
                                Text(
